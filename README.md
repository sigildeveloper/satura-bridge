...
2. На компьютере откройте `http://<bridge-pan-ip>/clip` (адрес, полученный сатурой от роутера)
...
MIT License. Подробнее см. [LICENSE](LICENSE). Обязательно сохранение оригинального уведомления об авторских правах.
