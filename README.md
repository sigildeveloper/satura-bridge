...
- Протестировано на Nokia S60, NetFront 3.4, J2ME приложениях
...
| Устройство | Статус |
|------------|--------|
| Nokia S60 (3rd edition) | ✅ Работает |
| NetFront 3.4 | ✅ Работает |
| Android (тест) | ✅ Работает |
| J2ME приложения | ✅ Работает |

Если проверил на своём устройстве — пиши в [чат](https://t.me/nnmidletschat), добавим в таблицу.
...
Автор: **@sigdev**
Сообщество: [t.me/nnmidletschat](https://t.me/nnmidletschat) — ретро-телефоны, J2ME, Nokia S60, NetFront
...
Chat: [t.me/nnmidletschat](https://t.me/nnmidletschat) — retro phones, J2ME, Nokia S60, NetFront
Author: @sigdev
