...
5. Select the firmware file:
   ...
   ```text
   firmware/satura-bridge-v0.0.13.bin
   ```
...
```bash
esptool --port COM3 --baud 460800 write-flash 0x0 firmware/satura-bridge-v0.0.13.bin
```
...
```bash
esptool.py --port COM3 --baud 460800 write_flash 0x0 firmware/satura-bridge-v0.0.13.bin
```
